...
STATIC_ADDR_PREFIX = '10.10.10.10/32'
...
ATTRACT_STATIC_1 = {'to_rt': [t.RT4],
                    'static_destination_prefix': STATIC_ADDR_PREFIX,
                    'redirect_rts': [t.RT5],
                    'classifier': {'destinationPort': '80',
                                   'protocol': 'tcp'
                                   }
...
TC_STATIC1 = vpn_instance.TrafficClassifier(
    destination_prefix=STATIC_ADDR_PREFIX,
    destination_port="80",
    protocol="tcp"
)
...
class TestVRF(t.BaseTestBagPipeBGP, TestCase):
    ...
    def _config_vrf_with_attract_traffic(self, attract_traffic,
        ...
        if (attract_traffic.get('to_rt') and
                attract_traffic.get('static_destination_prefix')):
            self.vpn.attract_static_dest_prefix = (
